#!/bin/bash
# Route 1: exact solves on aggregates of weakly supported nodes in the fine smoother (plus Lanczos steps, quadratic coarse).
T=/root/autodl-tmp/CLAUDE_TAKEOVER_20260923; S=$T/xcase_src_30; O=$T/R1_E4
...
run 0013_w01_t01_c32 $C13 --weak-rel 0.01 --weak-theta 0.1 --weak-cap 32
run 0013_w01_t001_c32 $C13 --weak-rel 0.01 --weak-theta 0.01 --weak-cap 32
run 0013_w1_t01_c32 $C13 --weak-rel 0.1 --weak-theta 0.1 --weak-cap 32
run 0013_w01_t01_c64 $C13 --weak-rel 0.01 --weak-theta 0.1 --weak-cap 64
run 0020_w01_t01_c32 $C20 --weak-rel 0.01 --weak-theta 0.1 --weak-cap 32
echo "$(date -u +%FT%TZ) E4_DONE" >> $O/status
