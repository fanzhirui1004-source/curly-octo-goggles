...
Route 7 speed-up: sub-cubes entirely inside the material get their moments in closed form (product of the 1-D
integrals (hi^(k+1) - lo^(k+1))/(k+1)), which the tensor Gauss rule reproduces exactly; everything else unchanged.
