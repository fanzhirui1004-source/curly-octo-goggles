...
These records support Sections 6.2, 6.4 and 6.5 of the main text. They are generated by `evidence/summarize_results.py` from `evidence/p1_checks_cpu.json` (script `p1_checks.py`).
