...
TOLS = (1e-3, 3e-4, 1e-4, 3e-5, 1e-5, 3e-6)
...
def main():
    ...
    Path('/root/autodl-tmp/NEURAL_SCHUR/HMAT_ECONOMY4.json').write_text(json.dumps(
    ...
    print('\nwritten HMAT_ECONOMY4.json (%.0f s)' % (time.time()-t0), flush=True)
